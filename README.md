...
scikit-learn models (#3) and gradient boosting (#4).
...
file. What each resume claim rests on: [docs/RESUME_CLAIMS.md](docs/RESUME_CLAIMS.md).
SHAP and the write-up are issues #5 and #6.
